...
public class PalindromeCalculator {
    ...
    public SortedMap<Long, List<List<Integer>>> getPalindromeProductsWithFactors(int min, int max) {
        ...
        ConcurrentMap<Long, List<List<Integer>>> palindromes =
            ...
            .collect(Collectors.groupingByConcurrent(pair -> pair.first,
                                                     Collectors.mapping(pair -> pair.second,
                                                                        Collectors.toList())));

        return new TreeMap<Long, List<List<Integer>>>(palindromes);
    }
