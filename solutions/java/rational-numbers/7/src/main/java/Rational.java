public record Rational(int numerator, int denominator) {
    ...
    public Rational(int numerator, int denominator) {
        ...
        int gcdAndSign = this.gcd(numerator, denominator) * ((denominator & 0x80000000) != 0 ? -1 : 1); // basically (denominator < 0) but cooler
        this.numerator = numerator / gcdAndSign;
        this.denominator = denominator / gcdAndSign;
    }
